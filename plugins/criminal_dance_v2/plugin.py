"""犯罪舞蹈 V2 - 基于 AppPlugin 状态机实现"""

from typing import Optional
from dorobot import AppPlugin, Message, ctx
from dorobot.space import Space
from loguru import logger

from .game import Game
from .controller import PlayCardController, CardPlayedMsg
...
def _get_game() -> Optional[Game]:
    """获取当前游戏实例"""
    space = app.get_space()
    return space.get("game")


def _save_game(game: Optional[Game]):
    """保存游戏实例"""
